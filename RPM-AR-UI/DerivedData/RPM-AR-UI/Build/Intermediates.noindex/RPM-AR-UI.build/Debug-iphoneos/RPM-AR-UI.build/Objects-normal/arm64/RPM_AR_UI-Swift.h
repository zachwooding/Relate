...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RPM_AR_UI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9RPM_AR_UI11AppDelegate")
...
@interface SearchViewController (SWIFT_EXTENSION(RPM_AR_UI)) <UISearchResultsUpdating>
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified childNameLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified sessionNumber;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified dateLabel;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
...
SWIFT_CLASS("_TtC9RPM_AR_UI22TutorialViewController")
@interface TutorialViewController : AVPlayerViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified tutBtn;
- (void)viewDidLoad;
- (IBAction)openTutorial;
